...
console.log(`step1, data1 = ${data1}`) // data1 is not defined
data1 = 20
...
// ==> var에 한해서만 hoisting에 의해 선언위치 위에서 변수 이용 가능
...
// var로 선언을 하면, 호이스팅이 되기는 한다.
// 선언부분만 위로 올린다. 값이 할당되기 전까지는 undefined 상태이다.
