// 데이터가 여러 개 있다.. 하나하나를 변수로 선언해서 이용..
let user1 = '홍길동'
let user2 = '김길동'
let user3 = '이길동'

// 모든 데이터를 여러 개라고 배열에 담아서 이용하는 것은 좋지 않다..
// 데이터가 상이한 성격이라면, 정확한 변수명으로 그 데이터가 식별되어 이용되게 하는 것이 맞다..
// 동일한 성격의 데이터 여러 개가 유지되어야 하거나, 데이터의 갯수가 예측이 안되거나(가변적일 때)
// 배열로 선언해서 데이터 이용..
