...
if(age < 30 && address === '서울'){
  console.log(`age: ${age}, address: ${address}, 나이 조건에 만족하고 서울에 거주합니다.`);
}else if(age < 30 && address === '부산'){
  console.log(`age: ${age}, address: ${address}, 나이 조건에 만족하고 부산에 거주합니다.`);
}else {
...
let data = 1
if(data){
  console.log('data is true'); // 여기서 실행
}else {
  console.log('data is false');
}

// if()에 들어가야 하는 값은 true/false
// 만약 숫자, 문자 등의 데이터가 들어오면 boolean으로 변형시켜서 판단하게 되어 있다.
